 ...
 */
   ...
   $columns_lg = orgarium_get_option('product_columns_lg', $std_lg);
   $columns_md = orgarium_get_option('product_columns_md', $std_md);
   $columns_sm = orgarium_get_option('product_columns_sm', $std_sm);
   $columns_xs = orgarium_get_option('product_columns_xs', $std_xs);
?>
