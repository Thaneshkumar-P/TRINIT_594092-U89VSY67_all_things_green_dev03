 ...
 */
	...
	$columns_lg = orgarium_get_option('portfolio_columns_lg', '4');
	$columns_md = orgarium_get_option('portfolio_columns_md', '3');
	$columns_sm = orgarium_get_option('portfolio_columns_sm', '2');
	$columns_xs = orgarium_get_option('portfolio_columns_xs', '1');
