<?php 
   ...
   $thumbnail = (isset($thumbnail_size) && $thumbnail_size) ? $thumbnail_size : 'orgarium_medium';
      ...
      <div class="<?php echo esc_attr($content_classes) ?>">
         <div class="content-inner">
            ...
            <div class="read-more-2">
               <a class="btn-border-theme" href="<?php echo esc_url( get_permalink() ) ?>"><?php echo esc_html__('Read more', 'orgarium'); ?></a>
            </div>
         </div>
