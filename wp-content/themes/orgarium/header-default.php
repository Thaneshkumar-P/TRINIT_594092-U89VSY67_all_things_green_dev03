...
$orgarium_logo = ORGARIUM_THEME_URL . '/assets/images/logo.png';
if(isset($orgarium_options['header_logo']['url']) && $orgarium_options['header_logo']['url']){
  $orgarium_logo = $orgarium_options['header_logo']['url'];
}
...
<body <?php body_class() ?>>
	...
	<div class="orgarium-page-loading"></div>
  	...
  	<div class="wrapper-page"> <!--page-->
	 	<?php do_action( 'orgarium_before_header' );  ?>
						...
						<div class="header-bottom-inner">
						  	...
						  	<div class="logo">
							 	<a class="logo-theme" href="<?php echo esc_url( home_url( '/' ) ); ?>">
									<img src="<?php echo esc_url($orgarium_logo); ?>" alt="<?php bloginfo( 'name' ); ?>" />
							 	</a>
						  	</div>
					  		...
					  		<div class="main-menu-inner">
							 	<div class="content-innter clearfix">
									<div id="gva-mainmenu" class="main-menu">
								  		<?php do_action('orgarium_main_menu'); ?>
									</div>
							 	</div> 
					  		</div>
	 	...
	 	<?php do_action( 'orgarium_after_header' );  ?>
