...
class GVAElement_Content_Carousel extends GVAElement_Base{
   ...
   public function get_title() {
      return __('Content Carousel', 'orgarium-themer');
   }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'    => [
                    'url' => GAVIAS_ORGARIUM_PLUGIN_URL . 'elementor/assets/images/image-3.jpg',
                ],
        ...
        $repeater->add_control(
          'shadow_sub_title',
          [
            'label'       => __('Shadow Sub Title', 'orgarium-themer'),
        ...
        $repeater->add_control(
          'sub_title',
          [
            'label'       => __('SubTitle', 'orgarium-themer'),
            'type'        => Controls_Manager::TEXT,
        ...
        $repeater->add_control(
          'btn_title',
          [
            'label'       => __('Button Title', 'orgarium-themer'),
            'type'        => Controls_Manager::TEXT,
            'default'     => esc_html__('Learn More', 'orgarium-themer'),
            'label_block' => true,
          ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
          'carousel_content',
          [
            'label'       => __('Content Item', 'orgarium-themer'),
            'type'        => Controls_Manager::REPEATER,
            'fields'      => $repeater->get_controls(),
            'title_field' => '{{{ title }}}',
            'default'     => array(
               array(
                  'shadow_sub_title'  => esc_html__( 'Top Stories', 'orgarium-themer' ),
                  'sub_title'         => esc_html__( 'Top Funding stories', 'orgarium-themer' ),
