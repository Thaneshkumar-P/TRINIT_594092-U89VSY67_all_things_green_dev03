...
class GVAElement_Video_Carousel extends GVAElement_Base{
   ...
   public function get_name(){
	...
	public function get_title() {
		return __('Video Carousel', 'orgarium-themer');
	}
   ...
   public function get_style_depends() {
	...
	protected function register_controls() {
	  	$this->start_controls_section(
			'section_videos',
			[
				'label' => __('Videos', 'orgarium-themer'),
			]
	  	);
		...
		$repeater = new Repeater();
	  	...
	  	$repeater->add_control(
			'video_link',
			[
				 'label'   => __('Video Link', 'orgarium-themer'),
				 'default' => 'https://www.youtube.com/watch?v=knTiUD5IAww',
				 'type'    => Controls_Manager::TEXT,
				 'description' => esc_html__( 'You can add youtube/vimeo video link', 'orgarium-themer' )
			]
	  	);
	  	...
	  	$this->add_control(
			'videos_content',
			[
				 'label'       => __('Video Content', 'orgarium-themer'),
