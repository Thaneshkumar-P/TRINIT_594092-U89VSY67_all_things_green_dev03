...
class GVAElement_Navigation_Menu extends GVAElement_Base {
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Navigation Menu', 'orgarium-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> Controls_Manager::SELECT,
				'options' 		=> array(
					'style-default'	=> esc_html__('Default', 'orgarium-themer'),
					'style-2'			=> esc_html__('Style II: Background, Flex', 'orgarium-themer')
				),
		...
		$this->add_control(
			'sub_menu_min_width',
			[
				'label' => __( 'Submenu Min Width (px)', 'orgarium-themer' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Main Menu', 'orgarium-themer' ),
		...
		$this->start_controls_tab(
			...
			[
				'label' => __('Normal', 'orgarium-themer'),
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			'main_menu_hover',
			[
				'label' => __('Hover', 'orgarium-themer'),
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'menu_top_line_color',
			[
				'label'     => __('Top Line Color', 'orgarium-themer'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'main_menu_padding',
			[
				'label' => __( 'Menu Item Padding', 'orgarium-themer' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Sub Menu', 'orgarium-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __('Link Color', 'orgarium-themer'),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
