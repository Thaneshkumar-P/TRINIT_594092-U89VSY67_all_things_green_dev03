...
class GVAElement_Circle_Progress extends GVAElement_Base {
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Circle Progress', 'orgarium-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'	  => esc_html__( 'Organic Foods Provides', 'orgarium-themer' )
			]
		);
		$this->add_control(
			'empty_fill',
			[
				'label' => __( 'Color EmptyFill', 'orgarium-themer' ),
		...
		$this->add_control(
			'width',
			[
			  	'label' => __( 'Width', 'orgarium-themer' ),
		...
		$this->add_control(
			'number',
			[
			  	'label' => __( 'Percentage', 'orgarium-themer' ),
			  	'type' => Controls_Manager::NUMBER,
				'min' => 5,
			  	'max' => 100,
			  	'step' => 1,
	 	...
	 	$this->add_control(
			'thickness',
			[
			  	'label' => __( 'Thickness', 'orgarium-themer' ),
			  	'type' => Controls_Manager::NUMBER,
				'min' => 1,
			  	'max' => 50,
			  	'step' => 1,
		...
		$this->add_control(
			'percentage_color',
			[ 
				'label' => __( 'Percentage Color', 'orgarium-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
