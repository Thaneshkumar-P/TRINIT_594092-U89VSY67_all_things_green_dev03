...
class GVAElement_Cart_Box extends GVAElement_Base {  
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'GVA Cart Box', 'orgarium-themer' );
	}
	...
	protected function register_controls() {
      ...
      $this->add_responsive_control(
         'icon_size',
         [
            'label' => __( 'Icon Size', 'orgarium-themer' ),
		...
		$this->add_control(
			'number_color',
			[
				'label' => __( 'Number Color', 'orgarium-themer' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
		...
		$this->add_control(
			'number_background',
			[
				'label' => __( 'Number Background', 'orgarium-themer' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
