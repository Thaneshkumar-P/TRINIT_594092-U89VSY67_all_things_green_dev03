...
class GVAElement_Posts extends GVAElement_Base{
	 ...
	 public function get_title() {
		  return __('Posts All Items', 'orgarium-themer');
	 }
	 ...
	 private function get_categories_list(){
		  ...
		  $categories['none'] = __('None', 'orgarium-themer');
		  $taxonomy = 'category';
	 ...
	 private function get_posts() {
		  ...
		  $posts['none'] = __('None', 'orgarium-themer');
	 ...
	 protected function register_controls() {
		  ...
		  $this->add_control( // xx Layout
			...
			$this->add_control(
				...
				[
					 ...
					 'default' => 'carousel',
					 'options' => [
						  'standard'      => __('Standard', 'orgarium-themer'),
						  'grid'          => __('Grid', 'orgarium-themer'),
						  'carousel'      => __('Carousel', 'orgarium-themer'),
						  'list'    		=> __('List', 'orgarium-themer'),
						  'small_list'    => __('Small List', 'orgarium-themer'),
						  'sticky'        => __('Post Large & List', 'orgarium-themer')
					 ]
				]
		  );
		  $this->add_control(
				...
				[
					 ...
					 'options' => [
						  'post-style-1'         => __('Item Post Style I', 'orgarium-themer'),
						  'post-style-2'         => __('Item Post Style II', 'orgarium-themer'),
						  'post-style-3'         => __('Item Post Style III', 'orgarium-themer')
					 ],
					 'condition' => [
		  	...
		  	$this->add_control(
				'image_size',
				[
					'label'     => __('Image Style', 'orgarium-themer'),
					'type'      => \Elementor\Controls_Manager::SELECT,
		  	...
		  	$this->add_control(
				'excerpt_words',
				[
					'label'     => __('Excerpt Words', 'orgarium-themer'),
					'type'      => 'number',
					'default'   => 15
				]
		  	);
		  	...
		  	$this->add_control( // xx Layout
				'query_heading',
				[
					'label'   => __('Query', 'orgarium-themer'),
					'type'    => Controls_Manager::HEADING,
				]
		  	);
		  	$this->add_control(
				'category_ids',
				[
					'label' => __('Select By Category', 'orgarium-themer'),
		  	...
		  	$this->add_control(
				'post_ids',
				[
					'label' => __('Select Individually', 'orgarium-themer'),
					'type' => Controls_Manager::SELECT2,
					'default' => '',
					'multiple'    => true,
					'label_block' => true,
		  	...
		  	$this->add_control(
				'posts_per_page',
				[
					'label' => __('Posts Per Page', 'orgarium-themer'),
		  	...
		  	$this->add_control(
				...
				[
					...
					'default' => 'post_date',
					'options' => [
					  	'post_date'  => __('Date', 'orgarium-themer'),
					  	'post_title' => __('Title', 'orgarium-themer'),
		  	...
		  	$this->start_controls_section(
				...
				[
					'label' => __('Right List Posts Style', 'orgarium-themer'),
		  	...
		  	$this->add_responsive_control(
				'stick_list_padding',
				[
					'label' => __('Padding List Posts', 'orgarium-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('Background List Posts', 'orgarium-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Title Color', 'orgarium-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Meta Color', 'orgarium-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  	...
		  	$this->start_controls_section(
				...
				[
					'label' => __('Post Content', 'orgarium-themer'),
					'tab'   => Controls_Manager::TAB_STYLE,
					'condition' => [
		  	...
		  	$this->add_responsive_control(
				'post_box_padding',
				[
					'label' => __('Padding Post Content', 'orgarium-themer'),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%' ],
					'selectors' => [
		  ...
		  $this->add_control(
				'post_box_background',
				[
					 'label' => __('Background Post Content', 'orgarium-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->start_controls_section(
				...
				[
					 'label' => __('Post Title', 'orgarium-themer'),
					 'tab'   => Controls_Manager::TAB_STYLE,
					 'condition' => [
						  'layout' => ['grid', 'carousel']
					 ],
		  ...
		  $this->add_control(
				...
				[
					 'label' => __('Color Title', 'orgarium-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->add_control(
				...
				[
					 'label' => __('Color Title Hover', 'orgarium-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->start_controls_section(
				...
				[
					 'label' => __('Post Description', 'orgarium-themer'),
					 'tab'   => Controls_Manager::TAB_STYLE,
					 'condition' => [
						  'layout' => ['grid', 'carousel']
					 ],
