...
class GVA_Elementor_Override{
   ...
   public function column_control($obj, $args){
      ...
      $obj->start_controls_section(
         'gva_column_control',
         array(
            'label' => esc_html__( 'Other Settings', 'orgarium-themer' ),
      ...
      $obj->add_responsive_control(
         ...
         [
            'label'     => __('Inner Width', 'orgarium-themer'),
   ...
   public function after_row_end( $obj, $args ) {
      ...
      $obj->start_controls_section(
         'gva_style_arrow_row',
         array(
            'label' => esc_html__( 'Shape Background', 'orgarium-themer' ),
            'tab'   => Controls_Manager::TAB_LAYOUT,
         )
      );
      ...
      // Shape Top 
      $obj->add_control(
         'gva_shape_top_control',
         [
            'label'     => __('Row Shape Top ----------', 'orgarium-themer'),
            'type'      => Controls_Manager::SWITCHER,
            'default'   => 'no',
            'prefix_class'    => 'shape-bg-top-'
         ]
      );
      $obj->add_control(
         'gva_row_shape_top',
         [
            'label' => __( 'Shape Top Image', 'orgarium-themer' ),
            'type' => Controls_Manager::MEDIA,
            'selectors' => [
               '{{WRAPPER}}:before' => 'background-image:url("{{URL}}");',
            ],
            'condition' => [
               'gva_shape_top_control' => ['yes']
            ]
         ]
      );
      ...
      // Shape Bottom 
      $obj->add_control(
         'gva_shape_bottom_control',
         [
            'label'     => __('Row Shape Bottom ----------', 'orgarium-themer'),
            'type'      => Controls_Manager::SWITCHER,
            'default'   => 'no',
            'prefix_class'    => 'shape-bg-bottom-'
         ]
      );
      $obj->add_control(
         'gva_row_shape_bottom',
         [
            'label' => __( 'Shape Bottom Image', 'orgarium-themer' ),
            'type' => Controls_Manager::MEDIA,
            'selectors' => [
               '{{WRAPPER}}:after' => 'background-image:url("{{URL}}");',
            ],
            'condition' => [
               'gva_shape_bottom_control' => ['yes']
            ]
         ]
      );
      $obj->end_controls_section();
      ...
      $obj->start_controls_section(
         'gva_section_row',
         array(
            'label' => esc_html__( 'Gavias Extra Settings Row for Header Builder', 'orgarium-themer' ),
            'tab'   => Controls_Manager::TAB_LAYOUT,
         )
      );
      ...
      $obj->add_control(
         'row_header_sticky',
         [
            'label'  => esc_html__( 'Sticky Row Settings (Use only for row in header)', 'orgarium-themer' ),
      ...
      $obj->add_control(
         '_gva_sticky_menu',
         [
            'label'     => __( 'Sticky Menu Row', 'orgarium-themer' ),
            'type'      => Controls_Manager::SELECT,
            'options'   => [
               '' => __( '-- None --', 'orgarium-themer' ),
               'gv-sticky-menu' => __( 'Sticky Menu', 'orgarium-themer' ),
            ],
            'default'         => '',
            'prefix_class'    => '',
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Background Color', 'orgarium-themer'),
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Text Color', 'orgarium-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Link Menu Color', 'orgarium-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Link Menu Hover Color', 'orgarium-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
   ...
   public function row_style($obj, $args){
      ...
      $obj->start_controls_section(
         ...
         array(
            'label' => esc_html__( 'Gavias Style Settings', 'orgarium-themer' ),
      ...
      $obj->add_control(
         ...
         [
            'label'     => __( 'Style Available', 'orgarium-themer' ),
            'type'      => Controls_Manager::SELECT,
            'options'   => [
               ''                 => __( '-- None --', 'orgarium-themer' ),
            ],
      ...
      $obj->add_control(
         ...
         [
            ...
            'label_block'  => true,
            'options' => [
               '' => __( '-- Default --', 'orgarium-themer' ),
               'theme'         => __( 'Background Color Theme', 'orgarium-themer' ),
               'theme-second'  => __( 'Background Color Theme Second', 'orgarium-themer' ),
            ],
            'default' => '',
            'prefix_class' => 'bg-row-',
         ]
