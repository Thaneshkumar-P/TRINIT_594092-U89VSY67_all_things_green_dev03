<?php
   add_filter( 'elementor/icons_manager/additional_tabs', 'orgarium_custom_icons_filters' , 9999999, 1 );
   function orgarium_custom_icons_filters( $tabs = array() ) {
      $newicons = [
         "flaticon-email",
         "flaticon-email-1",
         "flaticon-pin",
         ...
         "flaticon-checked", 
         "flaticon-share",
         "flaticon2-placeholder",
         "flaticon2-email",
         "flaticon2-harvest",
         "flaticon2-tractor",
         "flaticon2-agriculture",
         "flaticon2-social-care",
         "flaticon2-wheat-2",
         "flaticon2-wheat-sack",
         "flaticon2-grape",
         "flaticon2-cow",
         "flaticon2-fish",
         "flaticon2-healthy-food",
         "flaticon2-planet-earth",
         "flaticon2-cabbage",
         "flaticon2-farming",
         "flaticon2-agriculture-1",
         "flaticon2-cow-1",
         "flaticon2-tractor-1",
         "flaticon2-field",
         "flaticon2-phone-call",
         "flaticon2-agriculture-2",
         "flaticon2-industry"
      ];

      $icons['gva_custom_icon'] = array(
           'name'          => 'orgarium-icons-theme',
           'label'         => esc_html__( 'Icons Theme', 'orgarium-themer' ),
           'labelIcon'     => 'fas fa-user',
           'prefix'        => '',
           'displayPrefix' => '',
           'icons'         => $newicons,
           'url'          => GAVIAS_ORGARIUM_PLUGIN_URL . 'assets/icons/style.css',
           'ver'           => '1.0',
       );
   ...
   add_action( 'wp_print_footer_scripts', 'orgarium_insert_icons_footer_css'  );
   function orgarium_insert_icons_footer_css() {
      echo '<link rel="stylesheet" type="text/css" href="' . GAVIAS_ORGARIUM_PLUGIN_URL . 'assets/icons/style.css">';
   }

   add_filter( 'elementor/icons_manager/additional_tabs', 'orgarium_lineawesome_icon' );  
   function orgarium_lineawesome_icon( $icons = array() ) {
       ...
       $icons['orgarium-lineawesome-icon'] = array(
           'name'          => 'orgarium-icons-lineawesome',
           'label'         => esc_html__( 'Line Awesome', 'orgarium-themer' ),
           'labelIcon'     => 'fas fa-user',
           'prefix'        => '',
           'displayPrefix' => '',
           'icons'         => $lineawesome_icons,
            'url'          => GAVIAS_ORGARIUM_PLUGIN_URL . 'elementor/assets/libs/line-awesome/css/line-awesome.min.css',
           'ver'           => '1.0',
       );
