         ...
         <?php 
            if($sub_title){
               echo '<div ' . $this->get_render_attribute_string( 'sub_title' ) . '>';
                  ...
                  if($settings['heading_icon'] == 'yes' && $settings['icon_image']['url']){ 
                     echo '<span class="heading-icon"><img src="' . esc_url($settings['icon_image']['url']) . '" alt="" /></span>';
                  }

                  echo '<span class="tagline">' .  esc_html($sub_title) . '</span>'; 
                  
                  if($settings['heading_icon'] == 'yes' && $settings['align'] == 'center' && $settings['icon_image']['url']){
                     echo '<span class="heading-icon-right"><img src="' . esc_url($settings['icon_image']['url']) . '" alt="" /></span>';
                  }
