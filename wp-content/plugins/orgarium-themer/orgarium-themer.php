<?php 
/**
* Plugin Name: Orgarium Themer
* Description: Open Setting, Post Type, Shortcode ... for theme 
* Version: 1.0.2
* Author: Gaviasthemes Team
**/

define( 'GAVIAS_ORGARIUM_PLUGIN_URL', plugin_dir_url( __FILE__ ) );
define( 'GAVIAS_ORGARIUM_PLUGIN_DIR', plugin_dir_path( __FILE__ ) );

if (!function_exists('is_plugin_active')) {
   include_once(ABSPATH . 'wp-admin/includes/plugin.php');
}

class Gavias_Orgarium_Themer{
   ...
   public static function instance() {
	...
	public function __construct(){
      ...
      load_plugin_textdomain('orgarium-themer', false, 'orgarium-themer/languages/');
   ...
   public function gaviasthemer_ajax_url(){
	...
	public function include_files(){
      ...
      // Post Types
      require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'posttypes/portfolio.php');
      require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'posttypes/template.php');

      require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'redux/init.php');
      require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'includes/functions.php');
		require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'includes/hook.php');
      
      require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'sample/init.php'); 
      require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'widgets/recent_posts.php'); 

      //Template & Layout
      if (function_exists('is_plugin_active') && is_plugin_active( 'elementor/elementor.php' )) {
         require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'elementor/init.php'); 
         require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'layout/model.php'); 
         require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'layout/layout.php');
         require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'layout/hook.php');
         require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'layout/elementor.php');
         require_once(GAVIAS_ORGARIUM_PLUGIN_DIR . 'layout/frontend.php');
      }
	}
   ...
   public function register_scripts_admin() {
      ...
      wp_enqueue_style('orgarium-icons-custom', GAVIAS_ORGARIUM_PLUGIN_URL . 'assets/icons/style.css' );
   ...
   public function gavias_plugin_update() {
      ...
      Puc_v4_Factory::buildUpdateChecker(
         'http://gaviasthemes.com/plugins/dummy_data/orgarium-themer-update-plugin.json',
         __FILE__,
         'orgarium-themer'
      );
   }
