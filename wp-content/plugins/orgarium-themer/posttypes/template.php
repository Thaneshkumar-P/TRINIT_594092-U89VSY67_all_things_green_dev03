...
class Gavias_Themer_Template{
	...
	public function args_post_type_template(){
		$labels = array(
			'name'               => esc_html__( 'Template', 'orgarium-themer' ),
			'singular_name'      => esc_html__( 'Template', 'orgarium-themer' ),
			'add_new'            => esc_html__( 'Add Template', 'orgarium-themer' ),
			'add_new_item'       => esc_html__( 'Add Template', 'orgarium-themer' ),
			'edit_item'          => esc_html__( 'Edit Template', 'orgarium-themer' ),
			'new_item'           => esc_html__( 'New Template', 'orgarium-themer' ),
			'view_item'          => esc_html__( 'View Template', 'orgarium-themer' ),
			'search_items'       => esc_html__( 'Search Template Profiles', 'orgarium-themer' ),
			'not_found'          => esc_html__( 'No Template Profiles found', 'orgarium-themer' ),
			'not_found_in_trash' => esc_html__( 'No Template Profiles found in Trash', 'orgarium-themer' ),
			'parent_item_colon'  => esc_html__( 'Parent Template:', 'orgarium-themer' ),
			'menu_name'          => esc_html__( 'Templates & Layout', 'orgarium-themer' ),
		);
