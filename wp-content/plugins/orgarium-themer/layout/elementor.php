      ...
      if($post && $post->post_type === 'gva__template'){
         ...
         if($template_type == 'header_layout'){
            $document->add_control(
               'orgarium_header_position',
               [
                  'label'     => esc_html__('Header Position', 'orgarium-themer'),
                  'type'      => Controls_Manager::SELECT,
                  'options'   => array(
                     'relative'  => esc_html__('Relative', 'orgarium-themer'),
                     'absolute'  => esc_html__('Absolute', 'orgarium-themer'),
                  ),
                  'default' => 'relative',
               ]
            );
            $document->add_control(
               ...
               [
                  'label' => esc_html__('Background Black Demo', 'orgarium-themer'),
         ...
         if($show_preview){
            $document->add_control(
               'orgarium_post_preview',
               [
                  'label'     => esc_html__('Preview Content', 'orgarium-themer'),
                  'type'      => Controls_Manager::SELECT,
