	...
	public function parse( $file ) {
		...
		foreach ( $xml->channel->item as $item ) {
			...
			if ( isset( $wp->attachment_url ) ) {
				$post['attachment_url'] = GAVIAS_ORGARIUM_PLUGIN_URL . '/sample'  . ((string) $wp->attachment_url);
			}
...
class WXR_Parser_Regex {
	...
	function process_post( $post ) {
		...
		if ( $attachment_url ){
			$postdata['attachment_url'] = GAVIAS_ORGARIUM_PLUGIN_URL . '/sample' . $attachment_url;
		}
